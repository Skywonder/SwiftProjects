...
//  Quizzler
//
//  Created by Kuan-Ping Chang on 4/16/18.
...
class QuestionBank{
    var list = [Question]() //type class question
    
    init() {
        
        list.append(Question(text: "Valentine's day is banned by Saudi Arabia?", correctAnswer: true))
